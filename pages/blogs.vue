       ...
       ">
          ...
          ">
            <div>
              ...
              placeholder="Search..." type="search" name="search" id="search">
              ...
              ">
                ...
                <NuxtLink to="#" v-for="item in Array(6)" class="
                bg-white
                flex
                overflow-hidden
                rounded-md
                ...
                ">
                  <img class="
                  w-20
                  " src="~/assets/images/slider/slide-1.jpeg" alt="">
                  
                  <p class="
                  py-1
                  px-3
                  ">
                    Study in Cana with up to 100% of scholarship
                  </p>
                </NuxtLink>
            ...
            ">
              ...
              overflow-y-auto
              ">
                <BlogCard :sidebar="true" v-for="item in blogs" :image="item.image" :title="item.title" :description="item.description" :tags="item.tags" :date="item.date" :path="item?.path" />
              </div>
